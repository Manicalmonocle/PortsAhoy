...
| `human-2026-09-17-dark-77d.pa1` | none | 0 | day 77, pop 41 | straight | **the first dark run to beat the honest path**, and the fastest run on record. Berth on day 64, three prizes by day 76, and the first privateer captain ever hired in a trace. Powder at 4 rather than 8 took the raid rate from 0.03/day to 0.23/day. Finished on **1 plank**. |
